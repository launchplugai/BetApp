                ...
                "content": [
                    {
                        ...
                        "text": (
                            ...
                            "\n\n"
                            "IMPORTANT: Remove verbose phrases. Convert:\n"
                            "- 'To Record 8+ Assists' → '8+ assists'\n"
                            "- '3+ Made Threes' → '3+ threes'\n"
                            "- 'Over 220.5 Points' → 'over 220.5 pts'\n"
                            "\n"
                            "Return format: One leg per line. Use simple, direct format:\n"
                            "Player/Team + stat + threshold\n"
                            "\n"
                            "Use SHORT prop names:\n"
                            "- assists (not 'To Record Assists')\n"
                            "- pts or points\n"
                            "- 3pm or threes or made threes\n"
                            "- rebounds or reb\n"
                            "\n"
                            "Examples:\n"
                            "Jalen Brunson 8+ assists\n"
                            "Lakers ML\n"
                            "Cade Cunningham 3+ threes\n"
                            "Knicks -5.5\n"
                            "\n"
