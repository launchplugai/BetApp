...
|--------|-------------|------|------|
| S17-A | Live Data Ingestion | 4-5h | Low |
| S17-B | Protocol Tracking | 5-6h | Medium |
| S17-C | DNA Suggestions | 4-5h | Medium |
| **Total** | | **13-16h** | **Medium** |
...
- [ ] Provider interfaces abstract data sources
- [ ] Protocols track games in-memory
- [ ] Odds/score refresh works
- [ ] Suggestions generate on changes
- [ ] UI shows suggestions (dismissible)
- [ ] No API keys or live APIs yet
- [ ] All mock data (provider layer only)
